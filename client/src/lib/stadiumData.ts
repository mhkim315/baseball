...
export const STADIUM_BRIEFS: Record<string, StadiumBrief> = {
  ...
  "2": {
    ...
    homeTeams: "키움 히어로즈",
    ticket: { purchase: "놀티켓", price: "시즌별 가격제" },
    parking: { fee: "현장 484면(5부제) / 동양미래대 1,500원/30분", note: "현장 주차 협소. 대중교통 이용 권장" },
    transit: { subway: "1호선 구일역 2번 출구 도보 10분", bus: "160, 600, 6513, 6611" },
  },
  "3": {
    id: "3", name: "인천SSG랜더스필드", location: "인천 미추홀구", capacity: "23,000석",
    homeTeams: "SSG 랜더스",
    ticket: { purchase: "SSG닷컴", price: "11,000원(SKY뷰)~37,000원(홈런커플존)" },
  ...
  "4": {
    ...
    homeTeams: "KT 위즈",
    ticket: { purchase: "티켓링크", price: "10,000원(외야)~70,000원(테이블)" },
    parking: { fee: "3,000원(사전예약제)", note: "경기 7일 전 오후 5시 예약 오픈. 만석공원 공영주차장(도보 20분) 대체 가능" },
    transit: { subway: "수인분당선 수원시청역 2번 출구 도보 10분", bus: "2007, 621, 7770, 310, 991" },
  },
  "5": {
    id: "5", name: "한화생명이글스파크", location: "대전 중구", capacity: "13,000석",
    homeTeams: "한화 이글스",
    ticket: { purchase: "티켓링크", price: "9,000원(외야)~50,000원(프리미엄)" },
    parking: { fee: "무료(보문산 주차장)", note: "경기장 주변 주차 가능. 보문산 주차장 도보 10분" },
    transit: { subway: "1호선 대전역 도보 15분", bus: "102, 802, 311" },
  },
  "6": {
    id: "6", name: "대구삼성라이온즈파크", location: "대구 수성구", capacity: "24,000석",
    homeTeams: "삼성 라이온즈",
    ticket: { purchase: "티켓링크", price: "10,000원(외야)~80,000원(프리미엄)" },
    parking: { fee: "5,000원(사전예약)", note: "수성못 공영주차장 이용 가능. 셔틀버스 운행" },
    transit: { subway: "대구2호선 야구장역 1번 출구 바로 연결", bus: "509, 609, 급행1" },
  },
  "7": {
    id: "7", name: "광주기아챔피언스필드", location: "광주 북구", capacity: "20,500석",
    homeTeams: "KIA 타이거즈",
    ticket: { purchase: "티켓링크", price: "9,000원(외야)~60,000원(프리미엄)" },
    parking: { fee: "3,000원", note: "경기장 주차장 약 1,000대. 무등경기장 주차장 이용 가능" },
    transit: { subway: "광주1호선 문화전당역 도보 15분", bus: "금남51, 송정17, 지원45" },
  },
  "8": {
    id: "8", name: "사직야구장", location: "부산 동래구", capacity: "24,500석",
    homeTeams: "롯데 자이언츠",
    ticket: { purchase: "티켓링크", price: "9,000원(외야)~70,000원(프리미엄)" },
    parking: { fee: "5,000원", note: "사직종합운동장 주차장. 경기일 혼잡. 대중교통 권장" },
  ...
  "9": {
    ...
    homeTeams: "NC 다이노스",
    ticket: { purchase: "티켓링크", price: "9,000원(외야)~60,000원(프리미엄)" },
    parking: { fee: "3,000원(사전예약)", note: "마산종합운동장 주차장. 셔틀버스 운행" },
    transit: { subway: "없음 (버스 이용)", bus: "112, 260, 703" },
  },
};
...
export const STADIUM_PARKING: Record<string, ParkingSpot[]> = {
  ...
  "5": [
    { name: "보문산 주차장", description: "무료. 도보 10분" },
  ],
  "6": [
