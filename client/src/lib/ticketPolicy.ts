...
const TICKET_POLICY: Record<string, TeamTicketPolicy> = {
  LG: {
    name: "LG 트윈스", color: "#C8102E", venue: "잠실야구장", platform: "티켓링크 / LG 트윈스 홈페이지",
    tiers: [
  ...
  두산: {
    name: "두산 베어스", color: "#131230", venue: "잠실야구장", platform: "NOL티켓(인터파크) / 두산베어스 홈페이지",
    tiers: [
  ...
  키움: {
    name: "키움 히어로즈", color: "#820024", venue: "고척스카이돔", platform: "NOL티켓(인터파크) / 키움 히어로즈 홈페이지",
    tiers: [
  ...
  SSG: {
    name: "SSG 랜더스", color: "#CE0E2D", venue: "인천SSG랜더스필드", platform: "SSG닷컴 / 랜더스 앱",
    tiers: [
  ...
  NC: {
    name: "NC 다이노스", color: "#315288", venue: "창원NC파크", platform: "NC다이노스 앱 / 홈페이지",
    tiers: [
  ...
  롯데: {
    name: "롯데 자이언츠", color: "#041E42", venue: "사직야구장", platform: "롯데자이언츠 공식 사이트/통합앱",
    tiers: [
  ...
  KT: {
    name: "KT wiz", color: "#000000", venue: "수원KT위즈파크", platform: "wizzap 앱 / 티켓링크 / KT위즈 홈페이지",
    tiers: [
  ...
  KIA: {
    name: "KIA 타이거즈", color: "#EA0029", venue: "광주기아챔피언스필드", platform: "KIA 타이거즈 앱 / 티켓링크",
    tiers: [
  ...
  삼성: {
    name: "삼성 라이온즈", color: "#074CA1", venue: "대구삼성라이온즈파크", platform: "티켓링크",
    tiers: [
      { id: "season", name: "시즌권", dDay: null, time: null, maxTickets: null, seats: "본인 지정석", note: "별도 예매 불필요" },
