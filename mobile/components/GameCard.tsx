...
export default function GameCard({
  ...
  if (compact) {
    return (
      <Pressable onPress={onClick} style={[styles.compactCard, { borderLeftColor: home.primary }]}>
        <View style={styles.compactLeft}>
          <TeamBadge teamId={awayTeam} size="sm" variant="ball" />
          <Text style={[styles.compactTeam, { color: away.primary }]}>{away.shortName}</Text>
          {showScore ? (
          ...
          <Text style={[styles.compactTeam, { color: home.primary }]}>{home.shortName}</Text>
        </View>
