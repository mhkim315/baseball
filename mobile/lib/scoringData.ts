// Historical KBO team scoring averages (2020–2025)
// Computed from daily-scores API. For 2026+, fetch from server /score-summary/{year}.
...
export const HISTORICAL_SCORING: Record<number, Record<string, TeamScoring>> = {
  2020: {
...
/** Resolve team name for scoring lookup — handles SK→SSG rebrand in 2020. */
export function scoringTeamName(shortName: string, year: number): string {
  if (year === 2020 && shortName === "SSG") return "SK";
  return shortName;
}
